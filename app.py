...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "drox_hosting_secret_key_2024")
...
@app.route('/')
def home():
    return f"<h1>PNX Hosting Test Server</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">PNX Hosting</div>
